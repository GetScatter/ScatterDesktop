		...
		<section class="list-container">
			...
			<section class="scroller with-tail with-search">
				<section class="item-list">
					<section class="item" v-for="contact in visibleContacts">
						<section class="basics" :class="{'open':expanded && expanded.unique() === contact.unique()}">
							<figure class="chevron" @click="toggleExpansion(contact)">
								<i class="icon-right-open-big"></i>
							</figure>
							<section class="details" @click="toggleExpansion(contact)">
